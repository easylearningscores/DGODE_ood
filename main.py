...
from main_model import DGODE

def load_navier_stokes_data(path, sub=2, T_in=10, T_out=10, batch_size=2, reshape=None):
    ntrain = 1000
    neval = 100
    ntest = 100
...
def main(args):
    ...
    model = DGODE(shape_in=(args.T_in, 1, 32, 32), num_classes=8, batch_size=args.batch_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sub', type=int, default=2, help='Subsampling factor.')
